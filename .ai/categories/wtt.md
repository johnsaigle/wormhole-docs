...
2. Install the required dependencies. This example uses the SDK version `4.7.3`:
...
2. **Install dependencies**: Install the required dependencies. This tutorial uses the SDK version `4.7.3`:

    ```bash
    npm install @wormhole-foundation/sdk@4.7.3 tsx
    ```
