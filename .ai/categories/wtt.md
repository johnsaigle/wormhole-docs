...
- Source (raw): https://raw.githubusercontent.com/wormhole-foundation/wormhole-docs/main/.ai/pages/products-token-transfers-wrapped-token-transfers-tutorials-multichain-token.md
...
- Source (raw): https://raw.githubusercontent.com/wormhole-foundation/wormhole-docs/main/.ai/pages/products-token-transfers-wrapped-token-transfers-guides-fetch-signed-vaa.md
...
2. Install dependencies, including the [Wormhole TypeScript SDK](https://github.com/wormhole-foundation/wormhole-sdk-ts){target=\_blank}. This example uses the SDK version `4.7.1`:

    ```bash
   npm install @wormhole-foundation/sdk@4.7.1 -D tsx typescript
   ```
...
- Source (raw): https://raw.githubusercontent.com/wormhole-foundation/wormhole-docs/main/.ai/pages/products-token-transfers-wrapped-token-transfers-concepts-transfer-flow.md
...
- Source (raw): https://raw.githubusercontent.com/wormhole-foundation/wormhole-docs/main/.ai/pages/products-token-transfers-wrapped-token-transfers-get-started.md
...
2. Install the required dependencies. This example uses the SDK version `4.7.1`:
...
- Source (raw): https://raw.githubusercontent.com/wormhole-foundation/wormhole-docs/main/.ai/pages/products-token-transfers-wrapped-token-transfers-guides-wtt-contracts.md
...
- Source (raw): https://raw.githubusercontent.com/wormhole-foundation/wormhole-docs/main/.ai/pages/products-token-transfers-wrapped-token-transfers-guides-attest-tokens.md
...
5. Open `helper.ts` and add the following code:
    ...
    You can view the list of [supported platform constants](https://github.com/wormhole-foundation/wormhole-sdk-ts/blob/4.7.1/core/base/src/constants/platforms.ts#L6){target=_blank} in the Wormhole SDK GitHub repo.
...
2. Open `attest.ts` and add the following code:
    ...
    - **Calls [`getWrappedAsset`](https://github.com/wormhole-foundation/wormhole-sdk-ts/blob/4.7.1/connect/src/wormhole.ts#L277){target=\_blank}**: Part of the `Wormhole` class, the method does the following:
        - Accepts a [`TokenId`](https://github.com/wormhole-foundation/wormhole-sdk-ts/blob/4.7.1/platforms/aptos/protocols/tokenBridge/src/types.ts#L12){target=\_blank} representing a token on the source chain.
...
- **Calls `createAttestation`**: Defined in the `TokenBridge` interface, the [`createAttestation`](https://github.com/wormhole-foundation/wormhole-sdk-ts/blob/4.7.1/core/definitions/src/protocols/tokenBridge/tokenBridge.ts#L237){target=\_blank} method does the following:
...
- Source (raw): https://raw.githubusercontent.com/wormhole-foundation/wormhole-docs/main/.ai/pages/products-token-transfers-wrapped-token-transfers-tutorials-transfer-workflow.md
...
2. **Install dependencies**: Install the required dependencies. This tutorial uses the SDK version `4.7.1`:

    ```bash
    npm install @wormhole-foundation/sdk@4.7.1 tsx
    ```
...
- Source (raw): https://raw.githubusercontent.com/wormhole-foundation/wormhole-docs/main/.ai/pages/products-token-transfers-wrapped-token-transfers-guides-transfer-wrapped-assets.md
...
2. Install dependencies, including the Wormhole TypeScript SDK. This example uses the SDK version `4.7.1`:
...
- Source (raw): https://raw.githubusercontent.com/wormhole-foundation/wormhole-docs/main/.ai/pages/products-token-transfers-wrapped-token-transfers-faqs.md
...
- Source (raw): https://raw.githubusercontent.com/wormhole-foundation/wormhole-docs/main/.ai/pages/products-token-transfers-wrapped-token-transfers-overview.md
...
- Source (raw): https://raw.githubusercontent.com/wormhole-foundation/wormhole-docs/main/.ai/pages/products-token-transfers-wrapped-token-transfers-concepts-payload-structure.md
...
- Source (raw): https://raw.githubusercontent.com/wormhole-foundation/wormhole-docs/main/.ai/pages/products-token-transfers-wrapped-token-transfers-reference-supported-networks.md
