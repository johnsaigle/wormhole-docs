...
2. **Install dependencies**: Install the Wormhole SDK. This tutorial uses the SDK version `4.0.2`.
...
2. Install the required dependencies. This example uses the SDK version `4.0.2`:
